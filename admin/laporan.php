            ...
            <div class="content-wrapper">
                <div class="container-fluid">
                    ...
                    if (isset($_GET['submit'])) {
                        ...
                        <div class="panel panel-default">
                            <div class="panel-heading">Laporan Booking Tanggal
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="#myModal" data-toggle="modal"
                                                            data-load-code="<?php echo $result['id_trx']; ?>"
                                                            data-remote-target="#myModal .modal-body">
                                                            <?php echo $result['id_trx']; ?>
                                                        </a>
                                                    </td>
                                                    <td>
                        ...
                        <div class="form-group">
                            <a href="laporan_cetak.php?awal=<?php echo $mulai; ?>&akhir=<?php echo $selesai; ?>&nama_pimpinan=<?php echo urlencode($_GET['nama_pimpinan']); ?>"
                    ...
                    if (isset($_GET['submit'])) {
                        ...
                        <!-- Zero Configuration Table -->
                        <div class="panel panel-default">
                            <div class="panel-heading">Laporan Booking Bulan
                                <?php echo date('F Y', strtotime($bulan_tahun)); ?>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table id="zctb" class="display table table-striped table-bordered table-hover"
                        ...
                        <div class="form-group">
                            <a href="laporan_bulanan.php?bulan_tahun=<?php echo $bulan_tahun; ?>&nama_pimpinan=<?php echo urlencode($_GET['nama_pimpinan']); ?>"
                                target="_blank" class="btn btn-primary">Cetak</a>
                        </div>
                    <?php } ?>
                    ...
                    if (isset($_GET['submit'])) {
                        ...
                        <!-- Zero Configuration Table -->
                        <div class="panel panel-default">
                            <div class="panel-heading">Laporan Booking Tahun
                                <?php echo $tahun; ?>
                            </div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                        ...
                                        <tbody>
                                            ...
                                            while ($result = mysqli_fetch_array($querysewa)) {
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php
                                                        $bulan_transaksi = date('F', strtotime($result['tgl_trx']));
                                                    ...
                                                    <td>
                                                        <?php echo IndonesiaTgl(htmlentities($result['tgl_bayar'])); ?>
                                                    </td>
                                                    <td>
                                                        <?php echo format_rupiah($res['harga']); ?>
                                                    </td>
                        ...
                        <div class="form-group">
                            <a href="laporan_tahunan.php?tahun=<?php echo $tahun; ?>&nama_pimpinan=<?php echo urlencode($_GET['nama_pimpinan']); ?>"
                                target="_blank" class="btn btn-primary">Cetak</a>
                        </div>
                    <?php } ?>
